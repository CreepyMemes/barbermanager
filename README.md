...
```bash
cd ~/projects/manageBarber && docker compose -f docker-compose.prod.yml up -d --build
```
...
```bash
cd ~/projects/manageBarber && docker compose -f docker-compose.prod.yml exec -it backend sh
```
...
```bash
cd ~/projects/manageBarber && docker compose -f docker-compose.prod.yml down
```
