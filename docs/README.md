<div align="center">
  ...
  <h3>ManageBarber – Management Software for Barber Shops</h3>
</div>

# Description

**ManageBarber** is a comprehensive SaaS platform designed to streamline, digitalize, and optimize everyday operations in barber shops. With tools for booking, staff, client, and schedule management, ManageBarber ensures efficient workflows for admins, barbers, and clients alike.
